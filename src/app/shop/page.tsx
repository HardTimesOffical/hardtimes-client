...
export default function ShopPage() {
  ...
  // Исправляет ошибку Hydration: рендерим контент только после того, как клиент готов
  useEffect(() => {
    setMounted(true);
  }, []);
  ...
  // Пока компонент не смонтирован, возвращаем пустой макет или скелетон,
  // чтобы избежать ошибки "node to be removed is not a child of this node"
  if (!mounted) {
    return (
      <DashboardLayout>
