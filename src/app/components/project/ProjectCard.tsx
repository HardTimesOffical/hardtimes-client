...
export default function ProjectCard({ project }: { project: any }) {
  ...
  return (
    // Оборачиваем карточку в Link. Путь: /content/project/[slug]
    <Link href={`/content/project/${project.slug}`} className="block group">
      <div className="bg-card border border-border rounded-md p-4 transition-all hover:bg-secondary/10 cursor-pointer">
