...
export const metadata: Metadata = {
  ...
  description: "Сервера Майнкрафт. Найди идеальное место для игры с друзьями в майнкрафт. Рейтинг, статистика, отзывы и форум на нашем майнкрафт мониторинге серверов.",
  keywords: [
