...
export const metadata: Metadata = {
  ...
  title: {
    default: "Сервера Майнкрафт - мониторинг и рейтинг серверов с ip",
    template: "%s" 
  },
  description: "Список ТОП лучших серверов Майнкрафт для игры онлайн с IP-адресами. Ищете бесплатный сервер с модами, мини-играми, или просто сервер для игры с друзьями? Мониторинг серверов HardMonitroing поможет вам найти самый подходящий вариант!",
  keywords: [
